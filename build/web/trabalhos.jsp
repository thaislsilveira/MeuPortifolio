        ...
        <header>
            <div class="esquerda">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="semestre.jsp">Semestre</a></li>
                        <c:choose>
                            <c:when test="${not empty trabalhos}">
                                <c:forEach var="trabalho" items="${trabalhos}">
                                <li class="breadcrumb-item"><a href="semestre?idSemestre=${materia.semestre.idSemestre}">${materia.semestre.nomeSemestre}</a></li>
                                <li class="breadcrumb-item active" aria-current="page">${trabalho.nomeTrabalho}</li>
                                </c:forEach>
                            </c:when>
                        </c:choose>
                </ol>
