 ...
 */
@WebServlet(name = "CarregarSemestre", urlPatterns = {"/CarregarSemestre"})
public class CarregarSemestre extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try{
           ...
           request.getRequestDispatcher("alterarSemestre.jsp").forward(request, response);
       }catch(Exception ex){
           System.out.println("Problemas ao carregar dados do Semestre! Erro : " + ex.getMessage());
       }
    }
