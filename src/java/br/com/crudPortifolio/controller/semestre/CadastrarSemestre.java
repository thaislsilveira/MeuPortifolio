 ...
 */
@WebServlet(name = "CadastrarSemestre", urlPatterns = {"/CadastrarSemestre"})
public class CadastrarSemestre extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dao.cadastrar(oSemestre)) {
                ...
                mensagem = "Problemas ao cadastrar Semestre. Verifique os dados informados e tente"
                        + " novamente! ";
            }
