 ...
 */
@WebServlet(name = "Trabalho", urlPatterns = {"/Trabalho"})
       ...
       try
        {
            ...
            request.getRequestDispatcher("trabalhoCadastrar.jsp").forward(request, response);
        }
        catch(Exception ex){
            System.out.println("Problemas no Servlet ao Listar Trabalhos! Erro: " + ex.getMessage());
        }
    }
