...
public class Painel extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("qtdMaterias", materiaDao.countMateria());
            request.setAttribute("qtdProfessor", professorDao.countProfessor());
            request.setAttribute("qtdSemestre", semestreDao.countSemestre());
            request.setAttribute("qtdTrabalho", trabalhoDao.countTrabalho());

            request.getRequestDispatcher("adm.jsp").forward(request, response);
        } catch (Exception ex) {
            System.out.println("Erro na controller Painel: " + ex.getMessage());
        }
    }
