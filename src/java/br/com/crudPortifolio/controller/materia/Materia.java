 ...
 */
@WebServlet(name = "Materia", urlPatterns = {"/Materia"})
public class Materia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         try
        {
            ...
            request.getRequestDispatcher("materiaCadastrar.jsp").forward(request, response);
        }
        catch(Exception ex){
            System.out.println("Problemas no Servlet ao Listar tabela Matéria! Erro: " + ex.getMessage());
        }
    }
